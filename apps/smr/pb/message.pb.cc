...
PROTOBUF_CONSTEXPR msg::msg(
    ...
    /*decltype(_impl_.inline_message_)*/ {
...
const ::uint32_t TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::msg, _impl_.inline_message_),
};
...
msg::msg(const msg& from)
  ...
  _impl_.inline_message_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        _impl_.inline_message_.Set("", GetArenaForAllocation());
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_inline_message().empty()) {
    _this->_impl_.inline_message_.Set(from._internal_inline_message(), _this->GetArenaForAllocation());
  }
...
inline void msg::SharedDtor() {
  ...
  _impl_.inline_message_.Destroy();
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 10)) {
          auto str = _internal_mutable_inline_message();
...
::uint8_t* msg::_InternalSerialize(
  ...
  // bytes inline_message = 1;
  if (!this->_internal_inline_message().empty()) {
    const std::string& _s = this->_internal_inline_message();
...
void msg::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (!from._internal_inline_message().empty()) {
    _this->_internal_set_inline_message(from._internal_inline_message());
  }
...
void msg::InternalSwap(msg* other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.inline_message_, lhs_arena,
                                       &other->_impl_.inline_message_, rhs_arena);
}
